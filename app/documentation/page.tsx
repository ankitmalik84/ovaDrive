  ...
  return (
    <div className="pt-2">
      ...
      <div className="flex w-full h-full">
        ...
        <div className="hidden sm:block relative p-4 border-r-[0.08px] border-t-[0.08px] border-gray-300 rounded-tr-2xl sm:w-2/6 md:w-4/12 h-screen overflow-hidden">
        ...
        <div className="w-full sm:w-4/5 md:w-4/5 h-fit bg-customBlack2 ml-4 mr-4 sm:mr-12 rounded-xl">
