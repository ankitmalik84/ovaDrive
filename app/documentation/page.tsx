  ...
  return (
    <div className="pt-2">
      ...
      <div className="flex w-full h-full">
        ...
        <div className="hidden sm:block relative p-4 border-r-[0.08px] border-t-[0.08px] border-gray-300 rounded-tr-2xl w-2/6 sm:w-3/12 md:w-2/12 h-screen overflow-hidden">
        ...
        <div className=" w-full sm:w-9/12 md:w-10/12 h-fit bg-customBlack2 ml-4 mr-4 sm:mr-12 rounded-xl">
